...
export class Renderer {
  ...
  public randomiseColors() {
    this.geometry!.forEach(object =>
      object.setColor(...getRandomColor()),
    );
  }
  ...
  protected getStartingPosition() {
    ...
    return this.getObjectTargetPositionVector(
      startingPosX,
      startingPosY,
    );
  }
  ...
  protected getObjectTargetPositionVector(
    targetX: number,
    targetY: number,
  ) {
    ...
    const pos = this.camera!.position.clone().add(
