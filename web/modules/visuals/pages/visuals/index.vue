  ...
  <PageCard v-show="!isFullscreen" back-button-page="/">
    ...
    <div class="visualspage">
      <div class="visualspage-buttons">
        ...
        <LinkButton v-if="!isMobile()" text="Fullscreen" @click="requestFullscreen">
      ...
      <div class="visualspage-settings">
        <div class="visualspage-toggles">
          ...
          <ToggleSwitch
            ...
            label="Edge Bounce"
          />
          <ToggleSwitch v-else v-model="visualsStore.followCursor" label="Follow Cursor" />
        </div>
...
const fullscreenEvent = (): void => {
  const dynamicBackground = document.querySelector(".dynamicbackground") as HTMLElement;
