<template>
  <PageCard back-button-page="/visuals">
    ...
    <div v-if="selectedShape" class="editshapes-settings">
      <DropdownSelect v-model="selectedShape.type" label="Type" :options="geometryTypes" />
      ...
      <div class="editshapes-toggles">
        ...
        <ToggleSwitch v-model="selectedShape.reverseRotation" label="Reverse Rotation" />
      </div>
    ...
    <div class="editshapes-buttons">
      ...
      <LinkButton
        text="Delete"
        :style="{
          visibility: visualsStore.geometryConfig.length > 1 ? undefined : 'hidden',
        }"
        @click="deleteShape"
      >
