<template>
  <PageCard back-button-page="/" longform show-background>
    ...
    <ul>
      ...
      <ListItem>
        <p>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to {{ siteDomain }}.
        </p>
      </ListItem>
      <ListItem>
        <p>
      ...
      <ListItem>
        <p>
          <strong>Terms of Service</strong> (also referred as &quot;Terms&quot;) mean these Terms of
          Service that form the entire agreement between You and the Company regarding the use of
          the Service.
        </p>
      </ListItem>
      <ListItem>
      ...
      <ListItem>
        <p>
          <strong>Website</strong> refers to {{ siteDomain }}, accessible from
          <a :href="'https://' + siteDomain" rel="external nofollow noopener" target="_blank">{{
            "https://" + siteDomain
          }}</a>
        </p>
      </ListItem>
    ...
    <p>
      ...
      these Terms of Service. These Terms of Service apply to all visitors, users and others who
    ...
    <p>
      ...
      <a :href="mailtoLink">You can contact us here</a>.
    </p>
  </PageCard>
</template>

<script setup lang="ts">
const { siteDomain, mailtoLink } = useAppConfig();
</script>
