...
const { isVizshun } = useAppConfig()

useSeoMeta(isVizshun
  ? {
      title: 'Vizshun',
      ogTitle: 'Vizshun',
      description: 'Vizshun: Visual Artist / DJ / Digital Wizard',
      ogDescription: 'Vizshun: Visual Artist / DJ / Digital Wizard',
      ogImage: 'https://vizshun.art/social-card-alt.jpg?v=1',
    }
  : {
      title: 'Mark Metcalfe',
      ogTitle: 'Mark Metcalfe',
      description: 'Mark Metcalfe: Developer / Digital Wizard',
      ogDescription: 'Mark Metcalfe: Developer / Digital Wizard',
