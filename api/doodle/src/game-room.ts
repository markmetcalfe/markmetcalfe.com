...
export class GameRoom implements DurableObject {
  ...
  private doStartRound(): void {
    ...
    if (drawerSession) {
      this.send(drawerSession.ws, { type: "your_word", word: this.game.currentWord });
    }
  ...
  private doSkipRound(): void {
    ...
    this.game.roundNumber++;
    this.game.currentDrawerIndex = (this.game.currentDrawerIndex + 1) % this.game.drawOrder.length;
    this.game.phase = "drawing";
    this.game.alarmMode = "countdown";
    this.doStartRound();
  }
