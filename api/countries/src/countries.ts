...
// Sovereign states guessable in the game: the 193 UN member states plus
// Taiwan, Kosovo, Vatican City, and Palestine. Codes match the CSS class
// tokens used in assets/world.svg (derived from the Wikimedia "BlankMap-World.svg").
